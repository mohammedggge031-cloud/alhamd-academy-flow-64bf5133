...
const translations = {
  ...
  communicationLanguage: { en: "Communication Language", ar: "لغة التواصل" },
  langArabic: { en: "Arabic", ar: "العربية" },
  langEnglish: { en: "English", ar: "الإنجليزية" },
  langFrench: { en: "French", ar: "الفرنسية" },
  langUrdu: { en: "Urdu", ar: "الأردية" },
  langTurkish: { en: "Turkish", ar: "التركية" },
  langIndonesian: { en: "Indonesian", ar: "الإندونيسية" },
  langMalay: { en: "Malay", ar: "الماليزية" },
  langOther: { en: "Other", ar: "أخرى" },
  ...
  // Manager management
  accountManagement: { en: "Account Management", ar: "إدارة الحسابات" },
  accountManagementDesc: { en: "Add or remove admins and managers", ar: "إضافة أو إزالة المديرين والمشرفين" },
  ...
  accountRole: { en: "Account Role", ar: "نوع الحساب" },
  managerName: { en: "Name", ar: "الاسم" },
  managerEmail: { en: "Email", ar: "البريد الإلكتروني" },
  managerPassword: { en: "Password", ar: "كلمة المرور" },
  managerAdded: { en: "Account added successfully", ar: "تم إضافة الحساب بنجاح" },
  managerDeleted: { en: "Account removed successfully", ar: "تم إزالة الحساب بنجاح" },
  confirmDeleteManager: { en: "Are you sure you want to remove this account?", ar: "هل أنت متأكد من إزالة هذا الحساب؟" },
  noManagers: { en: "No accounts added yet", ar: "لم يتم إضافة حسابات بعد" },
  primaryAdmin: { en: "Primary Admin", ar: "المدير الرئيسي" },
  coAdmin: { en: "Admin", ar: "مدير" },
  resetPasswordFor: { en: "Reset password for", ar: "إعادة تعيين كلمة المرور لـ" },
  resetPassword: { en: "Reset Password", ar: "إعادة تعيين كلمة المرور" },
  passwordResetSuccess: { en: "Password reset successfully", ar: "تم إعادة تعيين كلمة المرور بنجاح" },
  forgotPassword: { en: "Forgot Password?", ar: "نسيت كلمة المرور؟" },
  forgotPasswordDesc: { en: "Enter your phone or email to request a password reset", ar: "أدخل رقم هاتفك أو بريدك الإلكتروني لطلب إعادة تعيين كلمة المرور" },
  forgotPasswordSent: { en: "Request sent! Admin will be notified", ar: "تم إرسال الطلب! سيتم إبلاغ الإدارة" },
  sendRequest: { en: "Send Request", ar: "إرسال الطلب" },
  forgotPasswordIdentifier: { en: "Phone or Email", ar: "رقم الهاتف أو البريد الإلكتروني" },
  ...
  notifTabAll: { en: "All", ar: "الكل" },
  notifTabReminders6h: { en: "6h Reminder", ar: "تذكير ٦س" },
  notifTabReminders5m: { en: "5m Alert", ar: "تنبيه ٥د" },
  notifTabHomework: { en: "Homework", ar: "واجبات" },
  notifTabReports: { en: "Reports", ar: "تقارير" },
  notifTabInvoices: { en: "Invoices", ar: "فواتير" },
  notifTabAlerts: { en: "Alerts", ar: "تنبيهات" },
